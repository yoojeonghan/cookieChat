...
/**
 * Created by ehfcn on 2017-07-21.
 */
...
public class Talk
{
    ...
    public Talk(GLRenderer GLRenderer, Bitmap bitmap)
    {
        /*-----------------------------------------------------------------------------*/
    ...
    public void draw(float[] mvpMatrix)
    {
        ...
        //GLES20.glBlendFunc(GLES20., GLES20.GL_BLEND_EQUATION_RGB);
